...
const SlideShowItem = ({ data }) => {
  ...
  const mobileImage = data.relationships.field_single_image_mobile.relationships.field_media_image.localFile.childImageSharp;
  const image = data.relationships.field_single_image.relationships.field_media_image.localFile.childImageSharp;
